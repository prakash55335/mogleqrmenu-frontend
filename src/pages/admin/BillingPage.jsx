...
import { generateBill, saveBillTotal } from '../../api/billingApi'
...
export default function BillPrint() {
  ...
  const grandTotal = taxAmounts.grandTotal   // ✅ used in handlePrint above
